...
-- Tu respuesta aquí
SELECT * FROM usuarios.usuarios_lenguajes;
...
SELECT COUNT(DISTINCT edad) as cantidad_de_usuarios FROM usuarios_lenguajes WHERE lenguaje = 'java';
...
SELECT * FROM usuarios_lenguajes WHERE edad = (SELECT MIN(edad) FROM usuarios_lenguajes);
...
WHERE edad > 30 AND lenguaje ='TypeScript';
...
SELECT *
FROM usuarios_lenguajes
WHERE edad < 30 AND lenguaje LIKE 'CSS';


-- Ejercicio 21: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar la cantidad de lenguajes que tienen.
-- Tu respuesta aquí

SELECT nombre, COUNT(lenguaje) 
FROM usuarios_lenguajes
...
SELECT COUNT(DISTINCT lenguaje) as cantidad_lenguajes
FROM usuarios_lenguajes
WHERE edad > 25;
...
SELECT COUNT('apellidos') AS Apedillo_con_G
FROM usuarios_lenguajes
...
SELECT *, (SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia_edad_promedio
FROM usuarios_lenguajes;
...
-- Tu respuesta aquí
-- No está en la tabla la fecha de creación
...
SELECT *,
(SELECT SUM(edad) FROM usuarios_lenguajes) AS SUMA_EDAD_TOTAL
FROM usuarios_lenguajes;
...
SELECT *
FROM usuarios_lenguajes
WHERE apellido LIKE 'p%' AND edad < 28 AND lenguaje IS NOT NULL;
